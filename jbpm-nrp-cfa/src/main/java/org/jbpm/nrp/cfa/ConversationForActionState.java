...
import org.jbpm.nrp.cfa.impl.ConversationActImpl;

public enum ConversationForActionState {
	REQUESTED(ConversationActKind.PROMISE, ConversationActKind.COUNTER_TO_INITIATOR, ConversationActKind.REJECT, ConversationActKind.WITHDRAW) {
	...
	public void acceptNewTerms(ConversationAct n) {
		throw new UnsupportedOperationException(this.name() + " does not support the operation 'acceptNewTerms'");
	}
